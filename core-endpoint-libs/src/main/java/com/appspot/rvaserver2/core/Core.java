...
public class Core extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Company {
    ...
    public class Add extends CoreRequest<com.appspot.rvaserver2.core.model.APIResponseCompanyWrapper> {
      ...
      protected Add(java.lang.String data, java.lang.String parentId) {
        super(Core.this, "PUT", REST_PATH, null, com.appspot.rvaserver2.core.model.APIResponseCompanyWrapper.class);
    ...
    public class Move extends CoreRequest<com.appspot.rvaserver2.core.model.APIResponseString> {
      ...
      protected Move(java.lang.String authKey) {
        super(Core.this, "POST", REST_PATH, null, com.appspot.rvaserver2.core.model.APIResponseString.class);
        this.authKey = com.google.api.client.util.Preconditions.checkNotNull(authKey, "Required parameter authKey must be specified.");
      }
    ...
    public class Update extends CoreRequest<com.appspot.rvaserver2.core.model.APIResponseCompanyWrapper> {
      ...
      protected Update(java.lang.String data, java.lang.String id) {
        super(Core.this, "POST", REST_PATH, null, com.appspot.rvaserver2.core.model.APIResponseCompanyWrapper.class);
        this.data = com.google.api.client.util.Preconditions.checkNotNull(data, "Required parameter data must be specified.");
        this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
      }
  ...
  public class Display {
    ...
    public class Add extends CoreRequest<com.appspot.rvaserver2.core.model.APIResponseDisplayWrapper> {
      ...
      protected Add(java.lang.String companyId, java.lang.String data) {
        super(Core.this, "PUT", REST_PATH, null, com.appspot.rvaserver2.core.model.APIResponseDisplayWrapper.class);
    ...
    public class Update extends CoreRequest<com.appspot.rvaserver2.core.model.APIResponseDisplayWrapper> {
       ...
       */
      protected Update(java.lang.String data, java.lang.String id) {
        super(Core.this, "POST", REST_PATH, null, com.appspot.rvaserver2.core.model.APIResponseDisplayWrapper.class);
        this.data = com.google.api.client.util.Preconditions.checkNotNull(data, "Required parameter data must be specified.");
        this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
      }
  ...
  public class Presentation {
    ...
    public class Add extends CoreRequest<com.appspot.rvaserver2.core.model.APIResponsePresentationWrapper> {
       ...
       */
      protected Add(java.lang.String companyId, java.lang.String data) {
        super(Core.this, "PUT", REST_PATH, null, com.appspot.rvaserver2.core.model.APIResponsePresentationWrapper.class);
        this.companyId = com.google.api.client.util.Preconditions.checkNotNull(companyId, "Required parameter companyId must be specified.");
        this.data = com.google.api.client.util.Preconditions.checkNotNull(data, "Required parameter data must be specified.");
      }
    ...
    public class Restore extends CoreRequest<com.appspot.rvaserver2.core.model.APIResponsePresentationWrapper> {
      ...
      protected Restore(java.lang.String id) {
        super(Core.this, "POST", REST_PATH, null, com.appspot.rvaserver2.core.model.APIResponsePresentationWrapper.class);
        this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
      }
    ...
    public class Update extends CoreRequest<com.appspot.rvaserver2.core.model.APIResponsePresentationWrapper> {
  ...
  public class Schedule {
    ...
    public class Add extends CoreRequest<com.appspot.rvaserver2.core.model.APIResponseScheduleWrapper> {
       ...
       */
      protected Add(java.lang.String companyId, java.lang.String data) {
        super(Core.this, "PUT", REST_PATH, null, com.appspot.rvaserver2.core.model.APIResponseScheduleWrapper.class);
        this.companyId = com.google.api.client.util.Preconditions.checkNotNull(companyId, "Required parameter companyId must be specified.");
        this.data = com.google.api.client.util.Preconditions.checkNotNull(data, "Required parameter data must be specified.");
      }
    ...
    public class Update extends CoreRequest<com.appspot.rvaserver2.core.model.APIResponseScheduleWrapper> {
       ...
       */
      protected Update(java.lang.String data, java.lang.String id) {
        super(Core.this, "POST", REST_PATH, null, com.appspot.rvaserver2.core.model.APIResponseScheduleWrapper.class);
        this.data = com.google.api.client.util.Preconditions.checkNotNull(data, "Required parameter data must be specified.");
        this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
      }
  ...
  public class User {
    ...
    public class Add extends CoreRequest<com.appspot.rvaserver2.core.model.APIResponseUserWrapper> {
      ...
      protected Add(java.lang.String companyId, java.lang.String data, java.lang.String username) {
        super(Core.this, "PUT", REST_PATH, null, com.appspot.rvaserver2.core.model.APIResponseUserWrapper.class);
        this.companyId = com.google.api.client.util.Preconditions.checkNotNull(companyId, "Required parameter companyId must be specified.");
        this.data = com.google.api.client.util.Preconditions.checkNotNull(data, "Required parameter data must be specified.");
    ...
    public class Update extends CoreRequest<com.appspot.rvaserver2.core.model.APIResponseUserWrapper> {
      ...
      protected Update(java.lang.String data) {
        super(Core.this, "POST", REST_PATH, null, com.appspot.rvaserver2.core.model.APIResponseUserWrapper.class);
        this.data = com.google.api.client.util.Preconditions.checkNotNull(data, "Required parameter data must be specified.");
      }
